...
autocmd FileType php html let @u='i<ul>o</ul>ÂÃ½aO'
autocmd FileType php html let @l='I<li>A</li>ÂÃ½aj'
autocmd FileType php html let @e='c<center></center>hhhhhhhhP'
autocmd FileType php html let @c='c<code></code>bhhP'
autocmd FileType php html let @i='c<img="">hP'
autocmd FileType php html let @b='i<br>hhh'
autocmd FileType php html let @m='c<b></b>hhhP'
autocmd FileType php html let @p='c<p>M/kbkb</p>hhhP'
autocmd FileType php html let @h='c<a href=""></a>hhhP'
autocmd FileType php html let @z='c<h1></h1>hhhhhp/</hl'
autocmd FileType php html let @x='c<h2></h2>bhhhp/</'
autocmd FileType php html let @v='c<h3></3kbh3>hhhhP'
autocmd FileType php html let @s='c<small></small>bblP'
